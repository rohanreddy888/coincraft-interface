  ...
  return (
    <div className="min-h-screen flex flex-col gap-4 justify-center items-center px-8">
      <Image
        ...
        height={"100"}
      />
      <div className="text-white text-xl md:text-2xl max-w-2xl text-center">
        <h1>Collect, Connect, Conquer!</h1>
        <p className="text-xl">
          <br />
      ...
      <div className="mt-4">
        <button className="bg-primary hover:bg-secondary font-medium text-lg flex flex-row gap-3 justify-center items-center px-6 py-2.5 rounded-xl">
